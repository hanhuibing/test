package com.cn.mine.elasticsearch.controller;
...
import com.cn.mine.elasticsearch.dao.BookDao;
...
public class BookController {
	...
	public List<Book> getBookByName(@RequestParam String name){
		...
		Iterator<Book> it = bookDao.search(qb).iterator();
	...
	public List<Book> searchCity(@PathVariable Integer page, @PathVariable Integer size, @PathVariable String q) {
		...
		BoolQueryBuilder bb = QueryBuilders.boolQuery().should(QueryBuilders.matchQuery("name", q));
		
		FunctionScoreQueryBuilder functionScoreQueryBuilder = QueryBuilders.functionScoreQuery(bb);
